        ...
        <section
            ...
            <div className="flex items-center justify-evenly w-full flex-wrap gap-4 mt-8">
                {dataContact && dataContact.map((item) => (
                    <a target="_blank" key={item.id} href={item.link} className="w-full md:w-auto px-3 md:px-8 py-5 border border-zinc-800 rounded-2xl hover:border-zinc-600 duration-100 ease-in-out cursor-pointer flex items-center justify-center gap-3">
